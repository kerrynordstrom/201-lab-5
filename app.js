...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var newSum = sum(sum(a,b)[0],c);
  var messageNewSum = a + ' and ' + b + ' and ' + c + ' sum to ' + newSum[0] + '.'
  var newProduct = multiply(multiply(a,b)[0],c);
  var messageNewProduct = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + newProduct[0] + '.'
  return[newSum[0], newProduct[0], messageNewSum, messageNewProduct];
}
...
function sumArray(testArray){ //eslint-disable-line
  var newSumArray = sum(sum((testArray)[0],(testArray)[1])[0],(testArray)[2])[0];
  console.log(newSumArray);
  var messageSumArray = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, ' + 'and ' + newSumArray + ' is their sum.'
  return[newSumArray, messageSumArray];
